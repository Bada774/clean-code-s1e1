...
var taskInput = document.querySelector(".new-item_task");//Add a new task.
...
var createNewTaskElement = function(taskString) {
  ...
  deleteButtonImg.classList.add("button-delete_image");
...
var taskCompleted = function() {
  ...
  var listItem = this.parentNode;
  listItem.children[1].classList.add("task-title_completed");
...
//Mark task as incomplete.
  ...
  var listItem = this.parentNode;
  listItem.children[1].classList.remove("task-title_completed");
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
}
